...
final class WebsitePagesReadService
{
        ...
        return [
            'home' => [
                ...
                'related' => [
                    ...
                    ['label' => 'Promotion banner', 'route' => 'website.promotions.index'],
                    ['label' => 'About section body', 'route' => 'website.about.edit', 'params' => ['tab' => 'homepage_about']],
                    ['label' => 'Our Worship programmes', 'route' => 'website.worship.edit'],
                    ['label' => 'Homepage activities', 'route' => 'website.activities.edit'],
            ...
            'worship' => [
                ...
                'type' => 'worship',
                'public_route' => 'public.home',
                'manage_route' => 'website.worship.edit',
                'description' => 'Homepage Our Worship cards: service times, titles, details, buttons, and the church location map.',
                'related' => [],
            ],
            'activities' => [
                'label' => 'Homepage Activities',
                'type' => 'activities',
                'public_route' => 'public.home',
                'manage_route' => 'website.activities.edit',
                'description' => 'Homepage Activities cards: titles, descriptions, icons, meeting times, and read-more links.',
                'related' => [],
            ],
            'about' => [
                'label' => 'About Us',
            ...
            'activity' => [
                ...
                'related' => [
                    ['label' => 'Homepage activity cards', 'route' => 'website.activities.edit'],
                ],
            ],
            'event' => [
                'label' => 'Events',
    ...
    public function defaultPageContent(string $pageKey): array
    {
        ...
        return match ($type) {
            'home' => [
                ...
                'testimonials_title' => 'Testimonies',
                'testimonials_intro' => 'Real grace, healing, and transformation in Christ.',
            ],
            'header' => [
                'heading' => $label,
                'eyebrow' => '',
    ...
    private function defaultLegalBody(string $pageKey, string $shortName): string
    {
        ...
        return match ($pageKey) {
            ...
            'mission-vision' => '<p><strong>Mission:</strong> Transforming the lives of people to be heavenly conscious and earthly useful</p><p><strong>Vision:</strong> A Spirit-filled church family transforming lives in Owerri and beyond.</p>',
