...
return [
    ...
    'public' => [
        ...
        'default_title' => env('PUBLIC_SITE_DEFAULT_TITLE', 'AGC Ikenegbu | Assemblies of God Church, Owerri'),
        'default_description' => env('PUBLIC_SITE_DEFAULT_DESCRIPTION', 'AGC Ikenegbu is an Assemblies of God church in Ikenegbu, Owerri, Imo State. Join us for Sunday worship, sermons, ministries, events, and a welcoming Christian community.'),
        'default_og_title' => env('PUBLIC_SITE_DEFAULT_OG_TITLE', 'AGC Ikenegbu | Assemblies of God Church, Owerri'),
        'default_og_description' => env('PUBLIC_SITE_DEFAULT_OG_DESCRIPTION', 'Sunday worship, sermons, ministries, and church events at AGC Ikenegbu in Ikenegbu, Owerri, Imo State.'),
