...
Route::get('/api/sdtg-gallery', [\App\Http\Controllers\PublicSite\PublicSdtgGalleryController::class, 'index'])
    ->middleware('throttle:60,1')
    ->name('public.sdtg.gallery.api');
Route::get('/api/get-sdtg-gallery.php', [\App\Http\Controllers\PublicSite\PublicSdtgGalleryController::class, 'index'])
    ->middleware('throttle:60,1');
Route::post('/api/sdtg-memory', [\App\Http\Controllers\PublicSite\PublicSdtgMemoryController::class, 'submit'])
    ->middleware('throttle:10,1')
    ->name('public.sdtg.memory.submit');
Route::post('/api/submit-sdtg-memory.php', [\App\Http\Controllers\PublicSite\PublicSdtgMemoryController::class, 'submit'])
    ->middleware('throttle:10,1');
Route::get('/donate', [\App\Http\Controllers\PublicSite\CmsPageController::class, 'show'])
    ->defaults('pageKey', 'donate')
    ->name('public.donate');
...
Route::get('/send-down-thy-glory', fn () => redirect()->route('public.sdtg'));
Route::permanentRedirect('/sdgt/', '/sdgt');
Route::get('/sdgt', [\App\Http\Controllers\PublicSite\LegacyBridgeController::class, 'sdtgIndex'])
    ->name('public.sdtg');
Route::get('/sdgt/{path}', [\App\Http\Controllers\PublicSite\LegacyBridgeController::class, 'sdtgPage'])
    ->where('path', '.*')
    ->name('public.sdtg.page');
...
Route::prefix('admin')->group(function () {
    ...
    require __DIR__.'/sdtg-auth.php';
    require __DIR__.'/sdtg-admin.php';
