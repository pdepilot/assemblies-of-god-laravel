<x-guest-layout>
    <div id="authLoginWrap">
        <div class="auth-welcome">
            ...
            <h2 class="auth-welcome__title">SDTG Admin Login</h2>
            <p class="auth-welcome__lead">{{ config('identity.admin.login_secondary_subtitle', 'Event Management Platform') }}</p>
        </div>

        <form id="authForm" class="auth-form" method="POST" action="{{ route('sdtg.login.store') }}">
            @csrf
            ...
            <div class="auth-form__meta">
                <a class="auth-link" href="{{ route('sdtg.password.request') }}">Forgot password?</a>
            </div>
            ...
            <p class="auth-form__footer">
                <a class="auth-link" href="{{ route('login') }}">AG Church ERP login</a>
            </p>
        </form>
    </div>
</x-guest-layout>
