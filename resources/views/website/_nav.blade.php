<div class="flex flex-wrap gap-2 text-sm">
    ...
    <a href="{{ route('website.worship.edit') }}" class="px-3 py-1 rounded border {{ request()->routeIs('website.worship.*') ? 'bg-indigo-600 text-white' : '' }}">Worship</a>
    <a href="{{ route('website.activities.edit') }}" class="px-3 py-1 rounded border {{ request()->routeIs('website.activities.*') ? 'bg-indigo-600 text-white' : '' }}">Homepage Activities</a>
    ...
    <a href="{{ route('website.promotions.index') }}" class="px-3 py-1 rounded border {{ request()->routeIs('website.promotions.*') ? 'bg-indigo-600 text-white' : '' }}">Promotions</a>
