        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 blog-studio">
            ...
            <div class="surface">
                <div class="panel-title">
                    <div>
                        <h2>Edit church post</h2>
                        <p>Title, cover, body HTML</p>
                    </div>
                </div>

                <form method="POST" action="{{ route('website.blog.update', $post['id']) }}" enctype="multipart/form-data" id="blogForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-actions">
                        ...
                        <a class="ghost-btn" href="{{ route('website.blog.show', $post['id']) }}">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
