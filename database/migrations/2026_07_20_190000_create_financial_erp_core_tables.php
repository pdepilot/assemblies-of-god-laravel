...
return new class extends Migration
{
    ...
    private function seedErpDefaults(): void
    {
        ...
        foreach ([
            ['TITH', 'Tithes', '4000'],
            ['OFFR', 'Offerings', '4010'],
            ['COVN', 'Covenant Offering', '4010'],
            ['SPOF', 'Special Offering', '4010'],
            ['XOSU', 'Cross Over Support', '4010'],
            ['FACL', 'Faith Clinic', '4010'],
            ['XOSD', 'Cross Over Seed', '4010'],
            ['AGCR', 'AG Care', '4010'],
            ['GCSP', 'General Council Support', '4010'],
            ['DSOF', 'District Support Offering', '4010'],
            ['FRFR', 'First Fruit', '4010'],
            ['HARV', 'Harvest Proceed', '4010'],
            ['WLFR', 'Welfare Offering', '4010'],
            ['ALTR', 'Altar Seed', '4010'],
            ['THGV', 'Thanksgiving Offering', '4010'],
            ['TEST', 'Testimony Offering', '4010'],
