...
/**
 * Final purge of any SDTG tables/rows still present in the AG church database.
 * SDTG data belongs only in the separate SDTG application / database.
 */
return new class extends Migration
{
    public function up(): void
    {
        ...
        try {
            foreach ($this->sdtgTables() as $table) {
    ...
    {
        // Intentionally empty — SDTG schema must not return to this database.
    }
